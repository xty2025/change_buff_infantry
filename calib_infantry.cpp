...
//   int idx = 1;
//   while (true) {
//     auto img_path = fmt::format("{}/{}.jpg", input_folder, idx);
...
//     if (!success) { idx++; continue; }

//     // 记录所需的数据
//     img_points.emplace_back(centers_2d);
//     obj_points.emplace_back(centers_3d(pattern_size, (float)center_distance_mm));
...
//   // 同时保存到文件
//   std::ofstream fout("calibration_result.yaml");
//   if (fout) {
//     fout << result.c_str();
//     fout.close();
//   } else {
//     fmt::print("无法写入 calibration_result.yaml\n");
//   }
// }
